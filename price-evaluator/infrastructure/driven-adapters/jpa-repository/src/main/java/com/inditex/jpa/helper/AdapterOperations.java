...
/**
 * Generic base class that bridges the gap between domain entities and JPA data entities.
 *
 * <p>This adapter abstracts the common operations between the domain model (E)
 * and the data model (D), handling conversion using a provided {@link Function} and {@link ObjectMapper}.
 *
 * <p>It supports save, find, and list operations, and makes use of Spring Data's {@link CrudRepository}
 * and {@link QueryByExampleExecutor} to query the persistence layer.
 *
 * <p>This pattern encourages separation of concerns and keeps your domain model
 * clean from infrastructure-related code.
 *
 * @param <E> Domain Entity
 * @param <D> Data Entity (JPA model)
 * @param <I> Identifier type (usually Long or String)
 * @param <R> Repository extending both CrudRepository and QueryByExampleExecutor
 */
